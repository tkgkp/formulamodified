...
group by  UD_SKL.SYMBOL, KH.SKR, M.KTM, M.N, ZGH.NRPRZ, ZGP.NRP, (case when ZGP.DOK is not null then 'RP' else '' end), ZGP.OPIS, ZL.OPIS, TWRKPLC.KOD

order by Wydział, "Symbol przew."