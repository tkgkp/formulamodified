...
where 
MG.SYM IN VALUES ('MAT'), ('XMAT1'), ('XMAT2') and SC.A='T' and SC.D between to_date(:_b) and to_date(:_c) and ND.Z='T'
...
from @SC
   ...
   left join MG using (ND.MAG,MG.REFERENCE)
where 
MG.SYM IN VALUES ('FSU'), ('KSU'), ('KMO'), ('MMO'), ('MSU') and SC.A='T' and ND.D between to_date(:_b) and to_date(:_c) and ND.Z='T'
