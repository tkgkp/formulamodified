:!UTF-8
/* Dokumenty zrodlowe biezacego roku wg rejestru i zakresu dat operacji */
...
where
REJ.KOD=':_c' and
DOK.DOP between to_date(:_d) and to_date(:_e) and
(':_a'='wszystkie' or ODD.OD=':_a')
order by
JEDN_KSIĘGOWA,REJESTR,D_OPERAC,NR_W_REJ
