:!UTF-8
/* Amortyzacja roczna bilansowa środków - plany amortyzacji*/
...
select 
    ...
    MA.K as METODA, 
    SRST.ROK as ROK,
    sum(SRST.AMOF) as AMORT_BIL
from SRST 
    left join ODD using (SRST.ODD, ODD.REFERENCE) 
    left join MA using (SRST.MF, MA.REFERENCE)
